...
# without the term theta^4 and in the absence of nanoparticles
...
[grid_info, temp_refr, intens_refr, Q_refr] = skin_calc(freq, PLANCK_OFF, REFR_ON, NANO_OFF);
[grid_info, temp, intens, Q] = skin_calc(freq, PLANCK_OFF, REFR_OFF, NANO_OFF);
...
filename = ["2/" int2str(freq) "_intens"];
