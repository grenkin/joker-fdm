...
tic
[grid_info, temp_pl, intens_pl, Q_pl] = skin_calc(freq, PLANCK_ON, REFR_ON, NANO_OFF);
toc
tic
[grid_info, temp, intens, Q] = skin_calc(freq, PLANCK_OFF, REFR_ON, NANO_OFF);
toc
